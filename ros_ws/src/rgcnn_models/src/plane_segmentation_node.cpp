...
#include <rgcnn_models/plane_segmentation_nodeConfig.h>
...
public:
  ...
  void
  dynReconfCallback(rgcnn_models::plane_segmentation_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  dynamic_reconfigure::Server<rgcnn_models::plane_segmentation_nodeConfig> config_server_;
