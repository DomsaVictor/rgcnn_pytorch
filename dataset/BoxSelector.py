...
class BoxSelect():
    def __init__(self, color_pass_cloud, cloud) -> None:
        ...
        self.sliders = [Scale(self.frame, from_=-200, to=200, length=300,  tickinterval=20, orient=HORIZONTAL) for i in range(9)]
        for i in range(9):
...
path_pointcloud = "/home/victor/Desktop/Dataset_from_ROS/plane_0.pcd"
