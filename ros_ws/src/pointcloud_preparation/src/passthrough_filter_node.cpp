...
#include <pointcloud_preparation/passthrough_filter_nodeConfig.h>
...
public:
  ...
  void
  dynReconfCallback(pointcloud_preparation::passthrough_filter_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  dynamic_reconfigure::Server<pointcloud_preparation::passthrough_filter_nodeConfig> config_server_;
