...
#include <rgcnn_models/compute_surface_normals_nodeConfig.h>
                              ...
                              pcl::PointCloud<pcl::PointNormal> &cloudnormals)
{
  ...
  void
  dynReconfCallback(rgcnn_models::compute_surface_normals_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  dynamic_reconfigure::Server<rgcnn_models::compute_surface_normals_nodeConfig> config_server_;
